...
export const settingsSchema = z.object({
  drawingColor: z.string().regex(hexColorRegex),
...
const metricValueSchema = z.union([z.string().max(200), z.number().finite(), z.boolean(), z.null()]);
...
export const eventSchema = z.object({
  ...
  payload: z
    ...
    .optional()
    .default({})
    .refine((value) => Object.keys(value).length <= 24, "payload deve conter no máximo 24 campos"),
